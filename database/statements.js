let createUser = `
    CREATE USER sistema IDENTIFIED BY 123

    ALTER USER sistema DEFAULT TABLESPACE Users
                  QUOTA UNLIMITED ON Users

    ALTER USER sistema TEMPORARY TABLESPACE temp

    GRANT CREATE SESSION, CREATE VIEW, ALTER SESSION, CREATE SEQUENCE TO sistema
    GRANT CREATE SYNONYM, CREATE DATABASE LINK, RESOURCE, UNLIMITED TABLESPACE TO sistema
`;
...
let drop_function = ["getPadre ", "DURACIONPROYECTO"];
...
let create_table = [
  ...
  `CREATE TABLE PROYECTO ( 
      ...
      CodPyto NUMBER(6) NOT NULL UNIQUE, 
  ...
  `CREATE TABLE UND_MEDIDA (
    COD_UND_MEDIDA NUMBER(6) NOT NULL,
    DESCRIPCION VARCHAR2(255),
    ABREVIATURA VARCHAR2(10),
    CONSTRAINT UND_MEDIDA_PK PRIMARY KEY (COD_UND_MEDIDA)
)`,
  // presupuesto modelo
  `CREATE TABLE PPRESUPUESTO (
    COD_PPRESUPUESTO NUMBER(6) NOT NULL,
    DESCRIPCION VARCHAR2(255),
    COD_PROYECTO NUMBER(6) NOT NULL,
    COD_CIA NUMBER(6) NOT NULL,
    CONSTRAINT PPRESUPUESTO_PK PRIMARY KEY (COD_PPRESUPUESTO)
)`,
  // categoría de titulos
  `CREATE TABLE CATEGORIA_TITULO (
    COD_CATEGORIA_TITULO NUMBER(6) NOT NULL,
    DESCRIPCION VARCHAR2(255),
    CONSTRAINT CATEGORIA_TITULO_PK PRIMARY KEY (COD_CATEGORIA_TITULO)
)`,
  // título para las partidas
  `CREATE TABLE TITULO ( 
    COD_TITULO NUMBER(6) NOT NULL,
    COD_CATEGORIA_TITULO NUMBER(6) NOT NULL,
    DESCRIPCION VARCHAR2(255),
    CONSTRAINT TITULO_PK PRIMARY KEY (COD_TITULO)
)`,
  // pivot para presupuesto y título
  `CREATE TABLE PPRESUPUESTO_TITULO (
    COD_PPRESUPUESTO_TITULO NUMBER(6) NOT NULL,
    COD_PPRESUPUESTO NUMBER(6) NOT NULL,
    COD_TITULO NUMBER(6) NOT NULL,
    COD_PRESUPUESTO_TITULO_PADRE NUMBER(6),
    PARCIAL NUMBER(6) NOT NULL,
    CONSTRAINT PPRESUPUESTO_TITULO_PK PRIMARY KEY (COD_PPRESUPUESTO_TITULO)
)`,
  // partidas
  `CREATE TABLE PPARTIDA (
    COD_PPARTIDA NUMBER(6) NOT NULL,
    DESCRIPCION VARCHAR2(255),
    COD_UND_MEDIDA NUMBER(6) NOT NULL,
    CONSTRAINT PPARTIDA_PK PRIMARY KEY (COD_PPARTIDA)
)`,
  // pivot para presupuesto_titulo y partida
  `CREATE TABLE PPARTIDA_DET (
    COD_PPARTIDA_DET NUMBER(6) NOT NULL,
    COD_PPARTIDA NUMBER(6) NOT NULL,
    COD_PPRESUPUESTO_TITULO NUMBER(6) NOT NULL,
    CANTIDAD NUMBER(6) NOT NULL,
    CONSTRAINT PPARTIDA_DET_PK PRIMARY KEY (COD_PPARTIDA_DET)
)`, //COD_PPARTIDA_PADRE NUMBER(6)
];
let create_foreign_key = [
  /*==============================================================*/
  ...
  /*************************************/
  /******PRESUPUESTO EXTERNO FK*****/
  /*************************************/
  `ALTER TABLE PPRESUPUESTO ADD CONSTRAINT PROYECTO_PPRESUPUESTO_FK
    FOREIGN KEY (COD_PROYECTO) REFERENCES PROYECTO(CodPyto)`,

  `ALTER TABLE TITULO ADD CONSTRAINT CATEGORIA_TITULO_TITULO_FK
    FOREIGN KEY (COD_CATEGORIA_TITULO) REFERENCES CATEGORIA_TITULO(COD_CATEGORIA_TITULO)`,

  `ALTER TABLE PPRESUPUESTO_TITULO ADD CONSTRAINT PPRESUPUESTO_PPRESUPUESTO_TITULO_FK
    FOREIGN KEY (COD_PPRESUPUESTO)
    REFERENCES PPRESUPUESTO(COD_PPRESUPUESTO)`,

  `ALTER TABLE PPRESUPUESTO_TITULO ADD CONSTRAINT TITULO_PPRESUPUESTO_TITULO_FK
    FOREIGN KEY (COD_TITULO)
    REFERENCES TITULO(COD_TITULO)`,

  `ALTER TABLE PPRESUPUESTO_TITULO ADD CONSTRAINT PPRESUPUESTO_TITULO_PADRE_PPRESUPUESTO_TITULO_FK
    FOREIGN KEY (COD_PRESUPUESTO_TITULO_PADRE)
    REFERENCES PPRESUPUESTO_TITULO(COD_PPRESUPUESTO_TITULO)`,

  `ALTER TABLE PPARTIDA_DET ADD CONSTRAINT PPRESUPUESTO_TITULO_PPARTIDA_DET_FK
    FOREIGN KEY (COD_PPRESUPUESTO_TITULO)
    REFERENCES PPRESUPUESTO_TITULO(COD_PPRESUPUESTO_TITULO)`,

  `ALTER TABLE PPARTIDA_DET ADD CONSTRAINT PPARTIDA_PPARTIDA_DET_FK
    FOREIGN KEY (COD_PPARTIDA)
    REFERENCES PPARTIDA(COD_PPARTIDA)`,

  `ALTER TABLE PPARTIDA ADD CONSTRAINT UND_MEDIDA_PPARTIDA_FK
    FOREIGN KEY (COD_UND_MEDIDA)
    REFERENCES UND_MEDIDA(COD_UND_MEDIDA)`,
];
let create_sequence = [
...
let seed = [
  ...
  `INSERT INTO CATEGORIA_TITULO (COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (1, 'Trabajos Preliminares')`,

  `INSERT INTO CATEGORIA_TITULO (COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (2, 'Movimiento de Tierras')`,

  `INSERT INTO CATEGORIA_TITULO (COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (3, 'Pavimentos')`,

  `INSERT INTO CATEGORIA_TITULO (COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (4, 'Alcantarillas TMC')`,

  `INSERT INTO CATEGORIA_TITULO (COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (5, 'Alcantarillas AMC')`,




  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (1, 1, 'MOVILIZACION Y DESMOVILIZACION DE EQUIPOS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (2, 1, 'TOPOGRAFIA Y GEOREFERENCIACION')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (3, 1, 'MANTENIMIENTO DE TRANSITO Y SEGURIDAD VIA')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (4, 2, 'CAMPAMENTO')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (5, 2, 'MOVIMIENTO DE TIERRAS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (6, 2, 'DESBROCE Y LIMPIEZA EN ZONAS NO BOSCOSAS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (7, 3, 'MATERIAL GRANULAR ESTABILIZADO CON EMULSION ASFALTICA 5%   ')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (8, 3, 'IMPRIMACION ASFALTICA')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (9, 3, 'MICROPAVIMENTO')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (10, 4, 'EXCAVACION NO CLASIFICADA PARA ESTRUCTURAS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (11, 4, 'RELLENO PARA ESTRUCTURAS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (12,4, 'ENCOFRADO Y DESENCOFRADO')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (13,5, 'EXCAVACION NO CLASIFICADA PARA ESTRUCTURAS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (14,5, 'RELLENO PARA ESTRUCTURAS')",

  "INSERT INTO TITULO (COD_TITULO, COD_CATEGORIA_TITULO, DESCRIPCION) VALUES (15, 5, 'ENCOFRADO Y DESENCOFRADO')",
];
